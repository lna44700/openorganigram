...
#include "../../src/Supervision/Switch.h"
...
void Switch::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Switch::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Switch::toggled)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Switch::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Switch.data,
...
void *Switch::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Switch.stringdata))

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_f_InterpreteurCommandes_t, stringdata0) + ofs \
...
void *f_InterpreteurCommandes::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_f_InterpreteurCommandes.stringdata0))
